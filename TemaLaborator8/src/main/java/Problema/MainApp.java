...
public class MainApp {
    ...
    public static void afisarePersoaneDupaDestinatie(Connection con) throws SQLException
    {
        ...
        boolean aux = false;
        System.out.println("Persoanele care au vizitat " + destinatia + " sunt: ");
        while(rs.next())
        {
            aux = true;
    ...
    public static void afisarePersoaneDintrunAn(Connection con) throws SQLException
    {
        ...
        ResultSet rs = stmt.executeQuery();
        boolean aux = false;
        System.out.println("Persoane care au fost in excursii in anul "+an+": ");
        while(rs.next())
        {
            aux = true;
            System.out.println("Persoana id: "+rs.getInt("id")+" Nume: "+rs.getString("nume")
        ...
        if(!aux)
        {
            System.out.println("Nu exista persoane cu excursii in acel an\n");
        }
    }
